  ...
  List<FAQItem> _getFAQItems() {
    return [
      ...
      FAQItem(
        ...
        answer:
            'Ya! NabungYuk adalah aplikasi edukasi yang aman. Semua data disimpan dengan aman dan hanya orang tua yang bisa mengontrol tabungan sesungguhnya.',
      ),
    ];
  }
        ...
        builder: (context, provider, child) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Helpers.verticalSpace(AppConstants.spacing8),
              Text(
                'Atau cari "NabungYuk Support" di WhatsApp',
                style: TextStyle(
                  fontSize: 12,
